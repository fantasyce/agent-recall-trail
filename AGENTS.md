...
- Memory and published knowledge are different object families. Agents cannot
  perform human governance. A bound Agent may perform distinctly labeled
  delegated governance only while the persistent local policy is enabled.
